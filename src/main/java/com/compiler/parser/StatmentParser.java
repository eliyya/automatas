...
public class StatmentParser {
    ...
    public static Statment parseIdentifierStatment(Parser parser) {
        var identifier = parser.expect(TokenKind.IDENTIFIER);
        if (parser.currentTokenKind() == TokenKind.PLUS_PLUS || parser.currentTokenKind() == TokenKind.MINUS_MINUS) {
    ...
    // // -----------------------
    // private static FunctionStatment parseFunctionStatment(Parser parser) throws
    // ExpectedError {
    // var type = parser.advance();
    // if (!TokenKind.isPrimitiveType(type)) {
    // throw new ExpectedError(parser, "type", type);
    ...
    // private static ParameterStatment parseParameterStatment(Parser parser) throws
    // ExpectedError {
    // var type = parser.advance();
    // if (!TokenKind.isPrimitiveType(type)) {
    // throw new ExpectedError(parser, "type", type);
    ...
    // private static DeclarationStatment parseUniqueVariableStatment(Parser parser)
    // throws ExpectedError {
    ...
    // }
    // var identifier = parser.expect(TokenKind.IDENTIFIER);
    // return new DeclarationStatment(tokenKind, List.of(new
    ...
    // // parse assignment
    // // ----------------
    // private static ExpressionStatment parseAssignmentStatment(Parser parser)
    // throws ExpectedError {
    ...
    // private static AssignmentExpression parseAssignment(Parser parser) throws
    // ExpectedError {
    ...
    // // ---------------------
    // private static ExpressionStatment parseUnaryOperation(Parser parser) throws
    // ExpectedError {
    ...
    // private static ExpressionStatment parsePostfixOperation(Parser parser) throws
    // ExpectedError {
    ...
    // }
    // parser.expect(TokenKind.SEMI);
    // return new ExpressionStatment(new UnaryOperationExpression(first, operation,
    // false));
    // }

    // private static ExpressionStatment parsePrefixOperation(Parser parser) throws
    // ExpectedError {
    // var operation = parser.advance();
    // if (!TokenKind.isUnaryOperation(operation)) {
    ...
    // throw new ExpectedError(parser, ";", semi);
    // }
    // return new ExpressionStatment(new UnaryOperationExpression(identifier,
    // operation, true));
    // }
